...
//
// Vendored from miniflux/v2 internal/reader/scraper/rules.go (Apache-2.0).
// Source: https://github.com/miniflux/v2/blob/main/internal/reader/scraper/rules.go

package extract

// predefinedRules maps a host (without leading "www.") to a CSS selector
// that picks the article body. Keys are alphabetically sorted.
